    ...
    <footer className="bg-gray-800 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-semibold mb-4 text-orange-500">Ramakrishna Centre</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/" className="text-gray-300 hover:text-orange-500 transition-colors duration-300">Home</Link></li>
              <li><Link to="/about" className="text-gray-300 hover:text-orange-500 transition-colors duration-300">About Us</Link></li>
              <li><Link to="/services" className="text-gray-300 hover:text-orange-500 transition-colors duration-300">Services</Link></li>
              <li><Link to="/gallery" className="text-gray-300 hover:text-orange-500 transition-colors duration-300">Photo Gallery</Link></li>
              <li><Link to="/development" className="text-gray-300 hover:text-orange-500 transition-colors duration-300">New Ashram Development</Link></li>
              <li><Link to="/learn" className="text-gray-300 hover:text-orange-500 transition-colors duration-300">Learn</Link></li>
            </ul>
          </div>
          
          <div>
            <h3 className="text-xl font-semibold mb-4 text-orange-500">Services</h3>
            <ul className="space-y-2">
